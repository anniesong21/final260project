...
top_states |>
  ...
  ggtitle("Top Ten States with the Highest Excess Mortality Rate per 100,000\nPeople by COVID-19 Wave") +
...
bot_states |>
  ...
  xlab("State") +
  ylab("Excess Mortality Rate per 100,000 people") +
  ggtitle("Top Ten States with the Lowest Excess Mortality Rate per 100,000\nPeople by COVID-19 Wave") 
